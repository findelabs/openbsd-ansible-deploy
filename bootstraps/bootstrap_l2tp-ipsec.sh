...
# Run playbook
cd /root/git/openbsd-ansible-dev/ && ansible-playbook install.yml --tags=users,system,unbound,vnstatd,l2tp-ipsec --extra-vars="user=$USERNAME pass=$PASSWORD psk=$PSK"
